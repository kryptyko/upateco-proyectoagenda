...
#  Feb 28, 2023 10:09:26 AM -03  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 600x450+2086+211
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    ...
    vTcl::widgets::ttk::pnotebook::createCmd "$top.pNo48" \
        -width 582 -height 448 -takefocus {} -style "PC.TNotebook" \
        -style PC.TNotebook 
...
### SPOT dump_widget_opt A
    ...
    ###################
    place $top.pNo48 \
        -in $top -x 0 -y 0 -width 0 -relwidth 0.97 -height 0 -relheight 0.996 \
